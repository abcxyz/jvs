// Taken from https://github.com/abcxyz/lumberjack/blob/main/clients/go/pkg/zlogger/logger.go
...
// Package zlogger sets up and configures standard logging.
// To better differentiate this from cloud logging and audit logging,
// we use `zlogger` instead of `logger` as the package name.
package zlogger
