...
var (
	certificateActionServiceServiceDescriptor                 = gen.File_cert_action_service_proto.Services().ByName("CertificateActionService")
...
type CertificateActionServiceClient interface {
	CertificateAction(context.Context, *connect.Request[gen.CertificateActionRequest]) (*connect.Response[gen.CertificateActionResponse], error)
}
...
func NewCertificateActionServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) CertificateActionServiceClient {
	...
	return &certificateActionServiceClient{
		certificateAction: connect.NewClient[gen.CertificateActionRequest, gen.CertificateActionResponse](
			httpClient,
...
type certificateActionServiceClient struct {
	certificateAction *connect.Client[gen.CertificateActionRequest, gen.CertificateActionResponse]
}

// CertificateAction calls abcxyz.jvs.CertificateActionService.CertificateAction.
func (c *certificateActionServiceClient) CertificateAction(ctx context.Context, req *connect.Request[gen.CertificateActionRequest]) (*connect.Response[gen.CertificateActionResponse], error) {
...
func (UnimplementedCertificateActionServiceHandler) CertificateAction(context.Context, *connect.Request[gen.CertificateActionRequest]) (*connect.Response[gen.CertificateActionResponse], error) {
