...
var (
	jVSPluginServiceDescriptor         = gen.File_jvs_plugin_service_proto.Services().ByName("JVSPlugin")
...
func NewJVSPluginClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) JVSPluginClient {
	...
	return &jVSPluginClient{
		validate: connect.NewClient[gen.ValidateJustificationRequest, gen.ValidateJustificationResponse](
			httpClient,
			baseURL+JVSPluginValidateProcedure,
			connect.WithSchema(jVSPluginValidateMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		getUIData: connect.NewClient[gen.GetUIDataRequest, gen.UIData](
			httpClient,
...
type jVSPluginClient struct {
	validate  *connect.Client[gen.ValidateJustificationRequest, gen.ValidateJustificationResponse]
	getUIData *connect.Client[gen.GetUIDataRequest, gen.UIData]
}

// Validate calls abcxyz.jvs.JVSPlugin.Validate.
func (c *jVSPluginClient) Validate(ctx context.Context, req *connect.Request[gen.ValidateJustificationRequest]) (*connect.Response[gen.ValidateJustificationResponse], error) {
	return c.validate.CallUnary(ctx, req)
}

// GetUIData calls abcxyz.jvs.JVSPlugin.GetUIData.
func (c *jVSPluginClient) GetUIData(ctx context.Context, req *connect.Request[gen.GetUIDataRequest]) (*connect.Response[gen.UIData], error) {
...
func (UnimplementedJVSPluginHandler) Validate(context.Context, *connect.Request[gen.ValidateJustificationRequest]) (*connect.Response[gen.ValidateJustificationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("abcxyz.jvs.JVSPlugin.Validate is not implemented"))
}

func (UnimplementedJVSPluginHandler) GetUIData(context.Context, *connect.Request[gen.GetUIDataRequest]) (*connect.Response[gen.UIData], error) {
